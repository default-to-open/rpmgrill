...
All setgid directories and setuid/setgid files must be enumerated in
a trusted whitelist. The U<default> location of the directory
containing the whitelist file is U<~/.rpmgrill/plugins/setxid/> and
can be overriden by setting B<RPMGRILL_SETXID_WHITELIST_DIR>
environment variable.

This whitelist is maintained by FIXME.
