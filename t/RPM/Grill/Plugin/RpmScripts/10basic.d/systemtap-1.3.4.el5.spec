...
%{!?with_bundled_elfutils: %global with_bundled_elfutils 1}
%{!?elfutils_version: %global elfutils_version 0.148}
%{!?pie_supported: %global pie_supported 1}
%{!?with_grapher: %global with_grapher 0}
...
Source1: elfutils-%{elfutils_version}.tar.bz2
...
%changelog
* Mon Nov 15 2010 Frank Ch. Eigler <fche@redhat.com> - 1.3-4
- CVE-2010-4170
- CVE-2010-4171

* Tue Nov  9 2010 Frank Ch. Eigler <fche@redhat.com> - 1.3-3
- rhbz648420.patch

* Tue Oct 12 2010 Frank Ch. Eigler <fche@redhat.com> - 1.3-2
- rhbz629190 testsuite deps (-prelink)

* Tue Aug 10 2010 Frank Ch. Eigler <fche@redhat.com> - 1.3-1
- Upstream release.

* Mon Jun 14 2010 Frank Ch. Eigler <fche@redhat.com> - 1.1-5
- rhbz560720.patch
- rhbz598615.patch

* Mon Jun 14 2010 Frank Ch. Eigler <fche@redhat.com> - 1.1-4
- rhbz568032.patch

* Wed Feb 17 2010 Frank Ch. Eigler <fche@redhat.com> - 1.1-3
- make executable the new test cases from below patches

* Wed Feb 17 2010 Frank Ch. Eigler <fche@redhat.com> - 1.1-2
- rhbz561889 = CVE-2010-0411: __get_argv overflows
- rhbz512202: update tcp/mib tapsets
- rhbz560890: stap -L/-l argument order preservation
- rhbz563114: syscall.* regression w/ sys_pipe32 disappearanced
- rhbz559643: fix testsuite bugs in labels.exp causing dejagnu hangs
- rhbz564445: fix sdt.h probes with prelinked libraries
- rhbz564443: harden unprivileged mode
- pr11286: fix stap-client --server=FOO
- rhbz556565: CVE-2009-4273 + CVE-2010-0412: more stap-server fixes
- pr11296: fix systemtap-testsuite sdt.h tests
